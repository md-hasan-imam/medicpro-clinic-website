        ...
        <footer>
            <div className="footer p-10 py-16 text-secondary">
                <div className=''>
                    ...
                    <p className=''>ClinicPro private ltd<br /> Providing reliable services since 1992</p>
            ...
            <div className="footer max-w-full footer-center mb-10 text-base-content">
                <div>
                    <p>Copyright © 2022 - All right reserved by ClinicPro</p>
                </div>
            </div>
        </footer>
