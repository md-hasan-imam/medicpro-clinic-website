            ...
            <div className="hero bg-base-100 py-5">
                <div className="hero-content flex-col lg:flex-row gap-x-10">
                    <div className='experience-image relative '>
                        ...
                        <div className='experience-overlay absolute top-50 left-2 bg-[rgba(255,0,0,0.6)] w-[95%] h-[95%]' >
                            <h2>15+ Years</h2>
                            <p>Experience</p>
                        </div>
                    </div>
                    ...
                    <div className='max-w-xl'>
                        ...
                        <h3 className="text-4xl font-semibold mt-3  md:mb-5">Most Effective Treatment</h3>
